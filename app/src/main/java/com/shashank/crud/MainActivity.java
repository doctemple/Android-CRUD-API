        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(Uid)){
                    uid.setError("UID "+R.string.not_empty) ;
                    valid = false;
                }else {
                    valid = true;

                    if(TextUtils.isEmpty(Name)){
                        name.setError("Name "+R.string.not_empty);
                        valid = false;
                    }else {
                        valid = true;

                        if(TextUtils.isEmpty(Address)){
                            address.setError("Address "+R.string.not_empty);
                            valid = false;
                        }else {
                            valid = true;

                            if(TextUtils.isEmpty(Phone)){
                                phone.setError("Contact Number "+R.string.not_empty);
                                valid = false;
                            }else {
                                valid = true;
                            }
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_ADD, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try{
                                ...
                                if(jsonObject.getString("message").equals(R.string.add_success)){
                        ...
                        public void onErrorResponse(VolleyError error) {
                            progressDialog.hide();
                            Toast.makeText(MainActivity.this, R.string.add_fail,Toast.LENGTH_SHORT).show();
                        }
                    }){
