    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                final CharSequence[] dialogitem = {context.getResources().getString(R.string.view_data),
                context.getResources().getString(R.string.edit_data),
                context.getResources().getString(R.string.delete_data)};
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                            ...
                            case 2 :
                                ...
                                builderDel.setMessage(R.string.delete_confirm);
                                builderDel.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_DELETE, new Response.Listener<String>() {
                                            ...
                                            public void onResponse(String response) {
                                                dialog.hide();
                                                dialog.dismiss();
                                                Toast.makeText(view.getContext(),R.string.delete_success+" ("+ listItem.getName()+")",Toast.LENGTH_LONG).show();
                                ...
                                builderDel.setNegativeButton(R.string.cancle, new DialogInterface.OnClickListener() {
                                    @Override
