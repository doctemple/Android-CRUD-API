                    ...
                    if(TextUtils.isEmpty(Name)){
                        ...
                        if(TextUtils.isEmpty(Address)){
                            ...
                            if(TextUtils.isEmpty(Phone)){
                                phone.setError("Contact "+R.string.not_empty);
                                valid = false;
                            }else {
                                valid = true;
                            }
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_UPDATE, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try{
                                ...
                                if(jsonObject.getString("message").equals(R.string.update_success)){
                        ...
                        public void onErrorResponse(VolleyError error) {
                            progressDialog.hide();
                            Toast.makeText(EditActivity.this, R.string.update_fail,Toast.LENGTH_SHORT).show();
                        }
                    }){
